...
*/
// 1.实现 firstName 函数
const firstName = (cars) => fp.flowRight(fp.prop('name'), fp.first)(cars);
// 2.打印测试
...
const sanitizeNames = (stringArr) => {
  return fp.flowRight(fp.map(fp.flowRight(_underscore, fp.lowerCase)))(
    stringArr
  );
};
// 2.打印测试
